...
<main>
    ...
    <section class="home_banner_sec">
        <div class="home_banner_img" id="banner_home">
            <div class="slider_item item_1">
                ...
                <div class="home_banner_content">
                    <div data-aos="fade-left" data-aos-delay="300" data-aos-duration="800">
                        <h2>Find The Perfect Images <span>For Your Next <br> Creative Project.</span></h2>
            ...
            <div class="slider_item item_2">
                ...
                <div class="home_banner_content">
                    <h2>Advertise Our <br> <span>Editing Feature/Tool</span></h2>
                    <div class="search_banner">
                        <div class="row">
                            <div class="col-3 p-0 pe-4">
                                <select>
            ...
            <div class="slider_item item_3">
                ...
                <div class="home_banner_content">
                    <h2>Advertise The <span>Print Options</span> We Offer <br> Through <span>Our Partner</span></h2>
                    <div class="search_banner">
                        <div class="row">
                            <div class="col-3 p-0 pe-4">
                                <select>
            ...
            <div class="slider_item item_4">
                ...
                <div class="home_banner_content">
                    <h2>We Take <span>Custom Orders</span><br>For <span>Custom Projects</span></h2>
                    <div class="search_banner">
                        <div class="row">
                            <div class="col-3 p-0 pe-4">
                                <select>
    ...
    <section class="fineart_gallery">
        <div data-aos="zoom-in-up" data-aos-delay="300" data-aos-duration="1000">
            <h2>Fine Art <span>Gallery</span></h2>
            <p>Placeholder is simply dummy text of the printing and typesetting industry Placeholder is simply dummy
                text.
            </p>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-xl-6 col-lg-7 col-md-12 col-sm-12 col-12">
                            <div class="premium_online_content" data-aos="fade-right" data-aos-delay="0"
                                ...
                                <button class="sign_up">Edit Now</button>
                            </div>
                        </div>
